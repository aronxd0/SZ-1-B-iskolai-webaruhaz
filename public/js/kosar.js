                ...
                cnt += `
                    <div class="row">
                        ...
                        <div class="col-12 d-flex justify-content-center p-3 mb-5" id="pay_button">
                            <button type="button" class="btn btn-lg btn-success bi bi-credit-card" id="tovabb_a_fizeteshez" onclick='RendelesAblak(${JSON.stringify(tetelekli)})'> Tovább a fizetéshez</button>
                        </div>
                    </div>

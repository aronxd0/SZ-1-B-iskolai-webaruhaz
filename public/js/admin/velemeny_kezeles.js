...
async function Admin_Velemenykezeles(pushHistory = true) {
    ...
    if (pushHistory) {
        ...
        history.pushState({ view: 'velemeny-kezeles' }, 'Vélemény kezelés', `#velemenykezeles`);
    }
}
                ...
                <div class="row !border-b !border-gray-300 dark:!border-b dark:!border-sky-950 pb-4 mt-3">
                    <div class="col-12 col-lg-8">
                        <div class="">
                            ...
                            <p class="text-zinc-600 dark:text-zinc-400 text-start">${element.SZOVEG.toString()}</p>
                    ...
                    <div class="col-12 col-lg-4">
                        <div class="d-flex align-items-center h-full justify-content-center justify-content-sm-end gap-2 mt-2">
                            <button class="px-3 py-1 text-sm lg:text-base rounded-4 !border !border-transparent bg-slate-900 text-zinc-200 dark:bg-gray-800 dark:text-zinc-200 hover:text-red-700 hover:bg-red-400/5 hover:!border-red-700 dark:hover:bg-red-900/20 dark:hover:!border-red-600/30 dark:hover:text-red-600    dark:!border-zinc-200/10  transition-all duration-150 ease-in-out w-auto" onclick="Velemeny_Elutasit(${element.ID_VELEMENY})"> 
                                <i class="bi bi-x-lg "></i> 
                                Elutasítás
                            </button>
                            <button class="px-3 py-1 text-sm lg:text-base rounded-4 !border !border-transparent bg-slate-900 text-zinc-200 dark:bg-gray-800 dark:text-zinc-200 hover:text-emerald-600 hover:bg-emerald-400/10 hover:!border-emerald-700 dark:hover:bg-emerald-900/20 dark:hover:!border-emerald-600/60 dark:hover:text-emerald-600  dark:!border-zinc-200/10  transition-all duration-150 ease-in-out w-auto" onclick="Velemeny_Elfogad(${element.ID_VELEMENY})"> 
            ...
            if (velemeny_osszes > 1) {
                ...
                <ul class="pagination justify-content-center gap-2 select-none mt-3">
                    <li class="page-item ${velemeny_jelenlegi == 1 ? "disabled hover:cursor-not-allowed" : ""}" >
                        <a id="Vissza2_vel" onclick="Kovi_vel(this)" class="page-link px-3 py-2 rounded-xl !border !border-transparent bg-zinc-50 text-slate-900 dark:bg-zinc-950 dark:text-zinc-200 hover:bg-slate-900 hover:text-white dark:hover:bg-gray-800 dark:!border-zinc-200/10 dark:hover:!border-zinc-200/20 transition-all duration-200 shadow-sm cursor-pointer"> « </a>
                    </li>
                    <li class="page-item ${velemeny_jelenlegi == 1 ? "disabled hover:cursor-not-allowed" : ""}">
                        <a id="Vissza1_vel" onclick="Kovi_vel(this)" class="page-link px-3 py-2 rounded-xl !border !border-transparent bg-zinc-50 text-slate-900 dark:bg-zinc-950 dark:text-zinc-200 hover:bg-slate-900 hover:text-white dark:hover:bg-gray-800 dark:!border-zinc-200/10 dark:hover:!border-zinc-200/20 transition-all duration-200 shadow-sm cursor-pointer ">                            
                    ...
                    <li class="page-item ${velemeny_jelenlegi == velemeny_osszes ? "disabled hover:cursor-not-allowed" : ""}">
                        <a id="Kovi1_vel" onclick="Kovi_vel(this)" class="page-link px-3 py-2 rounded-xl !border !border-transparent bg-zinc-50 text-slate-900 dark:bg-zinc-950 dark:text-zinc-200 hover:bg-slate-900 hover:text-white dark:hover:bg-gray-800 dark:!border-zinc-200/10 dark:hover:!border-zinc-200/20 transition-all duration-200 shadow-sm cursor-pointer ">
                            <span class="d-none d-lg-inline">Következő</span>
                            <i class="bi bi-caret-right-fill"></i>
                        </a>
                    </li>
                    <li class="page-item ${velemeny_jelenlegi == velemeny_osszes ? "disabled hover:cursor-not-allowed" : ""}">
                        <a id="Kovi2_vel" onclick="Kovi_vel(this)" class="page-link px-3 py-2 rounded-xl !border !border-transparent bg-zinc-50 text-slate-900 dark:bg-zinc-950 dark:text-zinc-200 hover:bg-slate-900 hover:text-white dark:hover:bg-gray-800 dark:!border-zinc-200/10 dark:hover:!border-zinc-200/20 transition-all duration-200 shadow-sm cursor-pointer "> » </a>
                    </li>
                </ul>`;
            }
            $("#velemenyek_hely").fadeOut(300, function() {
...
function Kovi_vel(keri){
    switch(keri.id){
        case "Kovi1_vel": // következő oldal
            if (velemeny_jelenlegi < velemeny_osszes) { velemeny_jelenlegi++; }
            break;
        ...
        case "Vissza1_vel": // előző oldal
            if (velemeny_jelenlegi > 1) { velemeny_jelenlegi--; }
            break;
